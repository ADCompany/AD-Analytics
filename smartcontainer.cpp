...
int  dl::CSmartContainer::getOccurrenceByIndex(int index) const
{
	switch (m_eDataType)
	{
		...
		case eDT_UFloat:
		{
			CDataContainer<udouble> const* pContainer = static_cast< CDataContainer<udouble> const* >(this);
			return pContainer->getOccurrenceByIndex(index);
			break;
		}
		case eDT_String:
...
void dl::CSmartContainer::removeByIndex( int nIndex )
{
	...
	case eDT_UFloat:
	{
		CDataContainer<udouble>* pContainer = static_cast< CDataContainer<udouble>* >(this);
		return pContainer->removeByIndex( nIndex );
		break;
	}
	case eDT_String:
...
// internalSort()
void dl::CSmartContainer::internalSort(bool isAscending = true)
{
	switch (m_eDataType)
	{
	case eDT_Bool:
...
// sort()
dl::t_IndexMap dl::CSmartContainer::sort(bool isAscending = true) const
{
	switch (m_eDataType)
	{
	case eDT_Bool:
